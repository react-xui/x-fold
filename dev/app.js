 ...
 * @LastEditTime: 2020-12-31 11:24:29
...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      <Tabs handle="header" defaultActive={["1","2","3"]} onChange={this.onChange}>
        <Panel className="xbc" tab="选项卡一" key="1">这是选项卡一的内容</Panel>
