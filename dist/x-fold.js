	    ...
	    value: function formatTabs() {
	      ...
	      _react2.default.Children.forEach(this.props.children, function (item, k) {
	        if (item && item.type === _Panel2.default) {
	          ...
	          headers.push(_react2.default.createElement('div', { key: key, className: cls }, _react2.default.createElement('div', { className: 'fold-title', onMouseEnter: _this2.onMouseEnter, onClick: _this2.onSelect.bind(_this2, key, 'header') }, _react2.default.createElement('i', { className: 'fold-title-icon', onClick: _this2.onSelect.bind(_this2, key, 'icon') }, _react2.default.createElement('svg', { viewBox: '64 64 896 896', 'data-icon': 'right', width: '1em', height: '1em', fill: 'currentColor', 'aria-hidden': 'true' }, _react2.default.createElement('path', { d: 'M765.7 486.8L314.9 134.7A7.97 7.97 0 0 0 302 141v77.3c0 4.9 2.3 9.6 6.1 12.6l360 281.1-360 281.1c-3.9 3-6.1 7.7-6.1 12.6V883c0 6.7 7.7 10.4 12.9 6.3l450.8-352.1a31.96 31.96 0 0 0 0-50.4z' }))), tab), _react2.default.createElement('div', { className: clsCon }, _react2.default.cloneElement(item))));
	        }
	      });
